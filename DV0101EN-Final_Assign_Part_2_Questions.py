...
data = \
    pd.read_csv('https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-DV0101EN-SkillsNetwork/Data%20Files/historical_automobile_sales.csv'
                )
...
dropdown_options = [{'label': 'Yearly Statistics',
...
app.layout = html.Div([html.H1('Automobile Sales Statistics Dashboard',
                    ...
                    # TASK 2.2: Add two dropdown menus
                      ...
                      options=[{'label': 'Yearly Statistics',
                      'value': 'Yearly Statistics'},
                      {'label': 'Recession Period Statistics',
                      'value': 'Recession Period Statistics'}],
...
@app.callback(Output(component_id='select-year',
...
@app.callback(Output(component_id='output-container',
...
# Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(figure=px.line(yearly_rec, x='Year',
                             y='Automobile_Sales',
...
# Plot 2 Calculate the average number of vehicles sold by vehicle type
        ...
        R_chart2 = dcc.Graph(figure=px.bar(average_sales,
                             ...
                             title='Average Automobile Vehicle Sales by Type over Recession Period'
                             ))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        unem_rec = recession_data.groupby(['unemployment_rate',
                'Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(unem_rec,
                             x='Vehicle_Type',
                             y='Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avg_vdata = yearly_data.groupby('Vehicle_Type'
                )['Automobile_Sales'].mean().reset_index()
        Y_chart3 = dcc.Graph(figure=px.bar(avg_vdata, x='Vehicle_Type',
                             y='Automobile_Sales',
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                             values='Advertising_Expenditure',
                             names='Vehicle_Type',
                             title='Total Advertisement Expenditure by Type'))
