...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4=dcc.Graph(figure=px.bar(unemployment_sales,x='unemployment_rate',y='Automobile_Sales',color='Vehicle_Type',title='Unemployment effects on vehicle type by sales'))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,x='Year',y='Automobile_Sales',title='Average Automobile Sales Yearly'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,values='Advertising_Expenditure',names='Vehicle_Type',title='Total Advertising Expenditure for Vehicle Type'))
